    ...
    const handleUpdateCoffee = event =>{
        ...
        .then(data =>{
            ...
            if(data.modifiedCount){
                Swal.fire({
                    title: 'Success!',
                    text: 'Coffee Updated Seuccessfully',
                    icon: 'success',
            ...
            <form onSubmit={handleUpdateCoffee}>
                ...
                <div className='md:flex gap-5 mb-8'>
                    <div className="form-control md:w-1/2">
                        ...
                        <label className="input-group">
                            <input type="text" name='supplier' defaultValue={supplier} placeholder="Coffee Name" className="input input-bordered w-full" />
                        </label>
                    </div>
                    <div className="form-control md:w-1/2">
                        <label className="label">
                        ...
                        <label className="input-group">
                            <input type="text" name='taste' defaultValue={taste} placeholder="Available Quantity" className="input input-bordered w-full" />
                        </label>
                    </div>
                </div>
